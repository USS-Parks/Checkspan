...
| M3 Multi-agent RAG and software pilot | CS-15–CS-24 → CS-R01–CS-R12 → CS-25 | Approved ("Run M3 STS now please", 2026-09-06); signer, corpus, model, and evaluation-budget stops remain | CS-15–CS-18 complete; local gates passed | Hosted: per-commit runs; recorded at CS-25 |
