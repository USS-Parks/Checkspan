...
- Current prompt: **CS-14 complete; M2 (CS-08–CS-14) accepted at cb63a14 on native Windows, native Linux, and the hosted matrix. Execution is STOPPED at the M2 milestone boundary pending Basho's explicit M3 approval; CS-15 is not started.**
...
| Test scratch directories | about 333 directories `checkspan-*` under `C:\Users\17076\AppData\Local\Temp`, each holding a small SQLite ledger or scratch files from one test run | Per-test temporary stores | May be deleted at any time; tests recreate what they need |
